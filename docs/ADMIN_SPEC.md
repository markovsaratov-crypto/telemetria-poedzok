...
> **Сервис:** Телеметрия поездок v2.11.0 · **Версия документа:** 2.11.0 · **Дата:** 2026-09-01
> **Объём:** 21 раздел · архитектура, деплой, токены, API, бэкапы, STRIDE, наблюдаемость
> Формат: Markdown (релиз v2.11.0; только MD, без DOCX-издания — см. решение пользователя «4 только мд»)
