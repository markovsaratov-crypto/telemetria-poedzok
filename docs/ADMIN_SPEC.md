...
> **Сервис:** Телеметрия поездок v2.9 · **Версия документа:** 2.9 · **Дата:** 2026-08-29
> **Объём:** 21 раздел · архитектура, деплой, токены, API, бэкапы, STRIDE, наблюдаемость
> Формат: Markdown (релиз v2.9; только MD, без DOCX-издания — см. решение пользователя «4 только мд»)
> Источник истины по метрикам: `docs/METHODOLOGY.md` v2.9 (62 метрики в 8 группах + служебный идентификатор `routeId`).
