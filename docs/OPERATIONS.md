...
## 4. Диагностика канала приёма (ingest) — DIAG-1, v2.10.6; DIAG-2, v2.10.7
...
| `no_gps` (янтарный) | запрос доходит, но координаты не распознаны — смотреть образец `sample` в L1: под какими ключами лежат данные |
