...
export function AdminViewV4() {
  ...
  return (
    <div ref={ref}>
      ...
      <div className="toast">
        <b>Служебная вкладка.</b> Параметры и диагностика соответствуют разделам методологии 2.9 (параметры расчёта, идемпотентность, кэширование, цепочка маршрутизации). Блоки A1–A4 — справочные из v4-прототипа, блоки L — live-интеграция с существующими API.
      </div>
    </div>
  );
}
  ...
  return (
    <section>
      <div className="sec-head">
        ...
        <span className="sec-sub">константы расчёта · методология 2.9</span>
      </div>
      <div className="card">
