 ...
 */
export const SESSION_CACHE_VERSION = 6; // driftScore §11.6: движение (записанная скорость ≥1 м/с) ≠ дрейф + пустой набор стационарных интервалов = нейтральный 1,0 (было NaN → «unreliable») — формулы в кэшированных payloads изменены
