 ...
 */
export const SESSION_CACHE_VERSION = 3; // v2.31.0: MAJ-7 (speedDistribution 5→6 бакетов §5.3) + MIN-13 (единый кап 200 км/ч меняет plausibilityScore) — формулы в кэшированных payloads изменены
